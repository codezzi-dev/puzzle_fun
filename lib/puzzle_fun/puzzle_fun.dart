...
class PuzzleFun extends ConsumerStatefulWidget {
  const PuzzleFun({super.key});

  @override
  ConsumerState<PuzzleFun> createState() => _HomePageState();
}

class _HomePageState extends ConsumerState<PuzzleFun> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    _winController = AnimationController(vsync: this, duration: const Duration(milliseconds: 600));
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          label,
          style: TextStyle(fontSize: 12.0, color: Colors.grey[600], fontWeight: FontWeight.w500),
        ),
      ],
    );
  }
    ...
    return GestureDetector(
      ...
      child: ScaleTransition(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            gradient: const LinearGradient(colors: [Color(0xFF6A4C93), Color(0xFF9B5DE5)]),
            borderRadius: BorderRadius.circular(30.0),
            boxShadow: [
              BoxShadow(
