  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (finishImage != null) {
      canvas.drawImageRect(
        finishImage!,
        Offset.zero & Size(finishImage!.width.toDouble(), finishImage!.height.toDouble()),
        Offset(_exit.col * _cellSize + squareMargin, _exit.row * _cellSize + squareMargin) &
    ...
    for (var i = 0; i < _checkpoints.length; i++) {
      canvas.drawImageRect(
        _checkpoints[i],
        Offset.zero & Size(_checkpoints[i].width.toDouble(), _checkpoints[i].height.toDouble()),
        Offset(
    ...
    canvas.drawImageRect(
      ...
      Offset(_player.col * _cellSize + squareMargin, _player.row * _cellSize + squareMargin) &
          Size(_cellSize - squareMargin, _cellSize - squareMargin),
      _playerPaint,
    );
  }
