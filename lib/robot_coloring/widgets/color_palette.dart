...
/// A color palette widget for selecting colors to paint robot parts
        ...
        children: [
          ...
          Wrap(
            ...
            children: colors.map((option) {
              final isSelected =
                  selectedColor != null &&
                  RobotColoringState.colorsMatch(selectedColor!, option.color);
              return _ColorButton(
                option: option,
      ...
      child: AnimatedBuilder(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: widget.option.color.withValues(alpha: 0.5),
