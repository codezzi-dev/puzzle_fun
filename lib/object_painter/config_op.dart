...
final List<ObjectTemplate> objectTemplates = [
  ...
  // Object 3: Tree 🌳 - fuller foliage using overlapping shapes
  ObjectTemplate(
    name: 'Tree',
    emoji: '🌳',
    parts: [
  ...
  // Object 7: Airplane ✈️ - Long slim fuselage
  ObjectTemplate(
    name: 'Airplane',
    emoji: '✈️',
    parts: [
  ...
  // Object 8: Castle 🏰 - Tall narrow towers
  ObjectTemplate(
    name: 'Castle',
    emoji: '🏰',
    parts: [
      ...
      ObjectPart(
        ...
        position: const Offset(35, 40),
        size: const Size(25, 140),
        color: Colors.amber,
      ),
      ObjectPart(
        id: 'tower_right',
  ...
  // Object 10: Train 🚂 - Long boiler and slim stack
  ObjectTemplate(
    name: 'Train',
    emoji: '🚂',
    parts: [
      ...
      ObjectPart(
        ...
        position: const Offset(165, 55),
        size: const Size(15, 45),
        color: Colors.brown,
      ),
      ObjectPart(
        id: 'wheel_big',
  ...
  // Object 11: Flower 🌸 - realistic petals and slim stem
  ObjectTemplate(
    name: 'Flower',
    emoji: '🌸',
    parts: [
  ...
  // Object 12: Butterfly 🦋 - Oval body and semicircular wings
  ObjectTemplate(
    name: 'Butterfly',
    emoji: '🦋',
    parts: [
  ...
  // Object 13: Truck 🚚 - realistic delivery truck proportions
  ObjectTemplate(
    name: 'Truck',
    emoji: '🚚',
    parts: [
